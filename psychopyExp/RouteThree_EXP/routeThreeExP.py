...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\ReGame-XR Lab\\ExerBike_CBH\\psychopyExp\\RouteThree_EXP\\routeThreeExP.py',
...
def run(expInfo, thisExp, win, inputs, globalClock=None, thisSession=None):
    ...
    while continueRoutine:
        ...
        if RouteThree.status == STARTED:
            ...
            if tThisFlipGlobal > RouteThree.tStartRefresh + 2007-frameTolerance:
